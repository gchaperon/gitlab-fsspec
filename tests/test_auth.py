...
def test_gitlab_auth_loads_from_env_private_token(monkeypatch):
...
def test_gitlab_auth_loads_from_env_oauth_token(monkeypatch):
...
def test_gitlab_auth_loads_ci_job_token_alias(monkeypatch):
...
def test_gitlab_auth_loads_gitlab_job_token_alias(monkeypatch):
...
def test_gitlab_auth_precedence_private_over_oauth(monkeypatch):
...
def test_gitlab_auth_precedence_oauth_over_job(monkeypatch):
...
def test_gitlab_auth_precedence_private_over_job(monkeypatch):
...
def test_get_auth_kwargs_returns_correct_precedence():
...
def test_get_auth_kwargs_oauth_when_no_private():
...
def test_get_auth_kwargs_job_when_only_job():
...
def test_get_auth_kwargs_empty_when_no_tokens():
...
def test_gitlab_auth_loads_from_env_file(tmp_path, monkeypatch):
...
def test_env_file_precedence_over_defaults(tmp_path):
...
def test_explicit_params_override_env_file(tmp_path):
...
def test_multiple_env_sources_precedence(tmp_path, monkeypatch):
...
def test_ci_job_token_precedence_in_env(monkeypatch):
